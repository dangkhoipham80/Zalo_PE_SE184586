...
public class ContactsFragmentViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<List<Contact>> allContacts = new MutableLiveData<>(new ArrayList<>());
    ...
    public ContactsFragmentViewModel(Application application) {
        super(application);
    ...
    public void search(String query) {
        List<Contact> list = allContacts.getValue();
        if (list == null) return;
